...
// echo $html;
echo "<table>";
echo "<tr><th>RP Number</th><th>Street</th><th>City</th><th>Zip Code</th><th>Room No</th><th>Rent</th><th>Property Status</th><th>Owner Phone</th><th>Actions</th></tr>";
while ($property_row = oci_fetch_array($stid, OCI_ASSOC+OCI_RETURN_NULLS)) {
  ...
  echo "<td><button onclick='createLeaseAgreement(" . $property_row['RPNUMBER'] . ")'>Create Lease Agreement</button></td>";
  echo "</tr>";
}
echo "</table>";
echo "</div>";
